...
Let $\hat{\psi}_a (k) = n_{k}(a,1) / n_k(a)$ be the natural estimator of $\psi_k (a) = \mathbb{E}[Y(a)|H=k]$ with $a \in \{0,1\}$. Let $\hat{\psi}(a) = \sum_{k=1}^K \hat{\pi}_k \hat{\psi}_k(a)$ the estimator of $\psi(a) = \mathbb{E}[Y(a)]$ where $\pi_k = \mathbb{P}(H = k)$ and $\hat{\pi}_k = n_k(a)/n_k$.
...
\sqrt{n} \: (\phi(\hat{\psi}_1,\hat{\psi}_0) - \phi(\psi_1,\psi_0)) \xrightarrow{L} N ( 0, \eta^2 )
