...
The estimates of the variance of the Risk Difference and the Risk Ratio can be found in the paper by Berenfeld et al. (2025). Given $\hat{\psi}_a (k) = n_{a1}(k) / n_a(k)$ the natural estimator of $ \mathbb{E}[Y(a)|H=k] $, the variance of the Odds Ratio in log-scale can be estimated by
...
An estimator of the variance of the Odds Ratio is the following:
